...
read_results_dir = "VOO_bb_bear_study"
results_dir = read_results_dir
save_results_dir = "VOO_bb_bear_study_post"
...
#png_path = os.path.join(save_results_dir, f"_VOO_bb_bear_study_post_new_invest.png")
#pdf_path = os.path.join(save_results_dir, f"_VOO_bb_bear_study_post.pdf")
pdf_path = os.path.join(save_results_dir, f"_VOO_bb_bear_study_post_new_invest.pdf")
