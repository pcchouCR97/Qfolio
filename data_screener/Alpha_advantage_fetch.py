...
def main():
    ...
    # symbols = ['AAPL','MSFT','AMZN','PLTR','ORCL','HOOD','VOO','NVDA']
    # symbols = ['AAPL', 'AMD', 'AMZN', 'ARKK', 'AXP', 'BA', 'BAC', 'BNTX', 'C', 'CRM', 'CSCO', 'CVX', 'DIS', 'GE', 'GEV', 'GOOGL', 'GS', 'HOOD', 'INTC', 'JPM', 'KO', 'LMT', 'MA', 'META', 'MRNA']
    # Tech giants (GOOGL, META, TSLA, NFLX)
    # Big tech infrastructure (INTC, AMD, CSCO, CRM, PFE)
    # Finance: JPM, V, MA, PYPL, AXP, BAC, C, GS, MS
    # Blue chips: DIS, WMT, KO, BA
    # Defense: LMT, NOC, RTX
    # Energy: XOM, CVX, OXY
    # Biotech: MRNA, BNTX, REGN
    # ETFs: VOO, VTI, QQQ, SPY, ARKK, XLF, XLE, XLY, XLI, XLB, XLK, XLV
    # GE, GEV
    ...
    if not all_adj_close.empty:
        filename = "Mag7_defenesive_adjusted_close.csv"
